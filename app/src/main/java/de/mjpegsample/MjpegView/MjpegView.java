...
/**
 * Author: Yves Raimond
 * Link: https://github.com/moustaki/raspbaby/tree/master/raspbaby-android/src/org/moustaki/raspbaby
 */

public class MjpegView extends SurfaceView implements SurfaceHolder.Callback {
    public final static int POSITION_UPPER_LEFT  = 9;//9
    public final static int POSITION_UPPER_RIGHT = 3;//3
    public final static int POSITION_LOWER_LEFT  = 12;//12
    public final static int POSITION_LOWER_RIGHT = 6;//6

    public final static int SIZE_STANDARD   = 1; 
    public final static int SIZE_BEST_FIT   = 4;
   // public final static int SIZE_FULLSCREEN = 0;
    ...
    public class MjpegViewThread extends Thread {
        ...
        private Rect destRect(int bmw, int bmh) {
            ...
            if (displayMode == MjpegView.SIZE_STANDARD) {
                ...
                //return new Rect(tempx, tempy, 2+tempx, 2+tempy);
            }
            if (displayMode == MjpegView.SIZE_STANDARD)//bestfit
            	{
                ...
                tempy = (dispHeight / 2) - (bmh / 2);
                return new Rect(tempx, tempy, bmw + tempx, bmh + tempy);
                //return new Rect(tempx, tempy, bmw, bmh);
            }
            if (displayMode == MjpegView.SIZE_STANDARD) return new Rect(0, 0, dispWidth, dispHeight);//full
            return null;
        }
                    ...
                    try {
                        ...
                        synchronized (mSurfaceHolder) {
                            try {
                                ...
                                if(showFps) {
                                    p.setXfermode(mode);
                                    if(ovl != null) {//top,bottom-ovl,left,right-ovl
